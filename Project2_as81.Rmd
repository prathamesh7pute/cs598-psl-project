...
```{r include = FALSE}
  ...
  mypackages = c("knitr", "kableExtra", "grid", "gridExtra", "EBImage", "class", "randomForest", "caret", "e1071", "doMC", "factoextra", "glmnet", "kernlib")
...
```{r include = FALSE}
  ...
  #                 cost=tuned_svm$best.parameters$cost, gamma=tuned_svm$best.parameters$gamma)
  # summary(best_svm)
```
