...
```{r results, echo=FALSE, results='asis'}
  q1_results = data.frame("Model" = c("Lasso", "SVM", "Random Forest"), "Accuracy" = c("64.00%", "75.00%", "93.00%"))
  q2_results = data.frame("Model" = c("Lasso", "Random Forest", ""), "Accuracy" = c("74.00%", "91.00%", ""))
...
```{r echo=FALSE, results='asis'}
  ...
  t2 <- kable(svm_test_confusionMatrix$table, format = "latex", booktabs = T)
